...
<body>
	...
	<form method="Post" action="/resources/edit?id=<%=aux.getId()%>" name="formulario">
		<label>Editar Recurso</label> <input type="text" name="url"
			value="<%=aux.getUrl()%>" placeholder="Añada el nuevo Recurso" autofocus
			required> <select name="estado" >
			<option value="true">True</option>
			<option value="false" <%if(!aux.isStatus()){ %> autofocus <% } %> >False</option>
		</select> <input name="Enviar" type="submit" value="Editar Resources" >
	</form>
	<script>
		(function(){
